...
export default function PasseiosCards({ destaque = false, limite }: PasseiosCardsProps) {
  ...
  const getDadosFallback = (): Passeio[] => [
    {
      id: "fallback-1",
      nome: "Tour Florença Renascentista",
      descricao: "Visite a Catedral de Santa Maria del Fiore, Ponte Vecchio e a Galeria Uffizi com guias credenciados.",
      preco: 65,
      duracao: "4h",
      categoria: "Histórico",
      imagens: ["https://images.unsplash.com/photo-1543429776-2782fc8e1acd?auto=format&fit=crop&q=80&w=1000"],
      capacidadeMaxima: 15,
      ativo: 1
    },
    {
      id: "fallback-2",
      nome: "Passeio pelas Colinas de Chianti",
      descricao: "Degustação exclusiva de vinhos refinados e azeites artesanais nas vinícolas históricas da Toscana.",
      preco: 85,
      duracao: "6h",
      categoria: "Gastronomia",
      imagens: ["https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?auto=format&fit=crop&q=80&w=1000"],
      capacidadeMaxima: 10,
      ativo: 1
    },
    {
      id: "fallback-3",
      nome: "Roma Imperial & Coliseu",
      descricao: "Explore o Coliseu, o Fórum Romano e o Panteão com ingresso prioritário e guia especialista.",
      preco: 75,
      duracao: "4h",
      categoria: "Histórico",
    ...
    {
      id: "fallback-4",
      nome: "Encantos de Siena e San Gimignano",
      descricao: "Um dia inesquecível explorando vilas medievais históricas no coração da Toscana.",
      preco: 95,
      duracao: "8h",
      categoria: "Cultural",
      imagens: ["https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&q=80&w=1000"],
      capacidadeMaxima: 20,
      ativo: 1
    },
    {
      id: "fallback-5",
      nome: "Roteiro Lucca e Pisa",
      descricao: "Descubra a famosa Torre de Pisa e caminhe pelas charmosas muralhas medievais de Lucca.",
      preco: 70,
      duracao: "5h",
      categoria: "Cultural",
      imagens: ["https://images.unsplash.com/photo-1520175480921-4edfa2983e0f?auto=format&fit=crop&q=80&w=1000"],
      capacidadeMaxima: 25,
      ativo: 1
    },
    {
      id: "fallback-6",
      nome: "Passeio por Val d'Orcia e Pienza",
      descricao: "Explore paisagens dos vinhedos toscanos tombados como Patrimônio Mundial da UNESCO.",
      preco: 80,
      duracao: "6h",
      categoria: "Natureza",
      imagens: ["https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&q=80&w=1000"],
      capacidadeMaxima: 8,
      ativo: 1
    }
  ];
